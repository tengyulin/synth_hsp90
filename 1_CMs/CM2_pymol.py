...
CM1_dir = os.path.join(pyDir,'CM1')
...
for CM in CM1_paths:
    ...
    for i in range(1,states+1):
        print(CM_name, i)
        cmd.rotate('z', 2.0, 'sele') #was originally 2; 1.44 results in ~0.439 Angstrom RMSD between CM2 states; peripheral atoms: {1.4, 1.5, 1.5} Angstrom
